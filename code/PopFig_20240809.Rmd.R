...
plot(x, sAS[,4], xlim = c(-50, 1050), ylim = c(0.02, 420), type = "b", 
     ...
     cex.lab = 1.5, las = 1, yaxt = "n", xaxt = "n", pch = 21, cex = 2)
box(lwd = 2)

segments(x, sAS[,4]-sAS[,5], x ,sAS[,4]+sAS[,5], col = "black", lwd = 2)

# A% decay
points(x, sAS[,6], type = "b", pch = 21, col = "black", cex = 2, lwd = 2, lty = 3)
segments(x, sAS[,6]-sAS[,7], x, sAS[,6]+sAS[,7], col = "black", lwd = 2)


# 3% decay
points(x, sAS[,2], type = "b", pch = 21, col = "black", cex = 2, lwd = 2, lty = 3)
